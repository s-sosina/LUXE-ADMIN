...
import { Edit, Ban, BadgeCheck } from "lucide-react";
import { useState } from "react";
import SuspendUserModal from "@/components/users/suspend-user-modal";
import EditDetails from "@/components/users/edit-details";
                ...
                <h2 className="text-xl font-semibold text-gray-900">
                  ...
                  className={`h-5 w-5 transition-colors ${
                    user.isVerified
                      ...
                      : "text-gray-600 fill-gray-100"
                  }`}
                  aria-label={user.isVerified ? "Verified user" : "Unverified user"}
                />
              </div>
